// hide calcul content//
function myFunction() {
  var x = document.getElementById("calculator_content");
...
function myFunctionweather() {
    var x = document.getElementById("weather_content");
    if (x.style.display === "block") {
      x.style.display = "none";
    } else {
      x.style.display = "block";
...
// hide agenda content//
function myFunctionagenda() {
    var x = document.getElementById("agenda_content");
    if (x.style.display === "block") {
      x.style.display = "none";
    } else {
      x.style.display = "block";
...
// hide currency content//
function myFunctioncurrency() {
    var x = document.getElementById("currency_content");
    if (x.style.display === "block") {
      x.style.display = "none";
    } else {
      x.style.display = "block";
